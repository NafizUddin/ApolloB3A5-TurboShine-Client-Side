      ...
      <footer className="w-full">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3 gap-y-8 md:gap-8 py-10 max-w-sm mx-auto sm:max-w-3xl lg:max-w-full">
            ...
            <div className="lg:mx-auto text-left ">
              <h4 className="text-lg text-primary font-medium mb-7">Support</h4>
              <ul className="text-sm  transition-all duration-500">
                <li className="mb-6">
                  <a href="" className="text-gray-600 hover:text-gray-900">
                    Customer Support
            ...
            <div className="lg:mx-auto text-left ">
              ...
              <a
                href=""
                className="flex items-center justify-center gap-2 border border-primary rounded-full py-3 px-6 w-fit lg:mx-0  text-sm text-primary font-semibold transition-all duration-500 hover:bg-indigo-50"
              >
                Subscribe
                <svg
                  width="15"
          ...
          <div className="py-7 border-t border-gray-200">
            <div className="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
              ...
              <div className="flex mt-4 space-x-4 sm:justify-center lg:mt-0 ">
                <a
                  href=""
                  className="w-8 h-8 rounded-full transition-all duration-500 flex justify-center items-center bg-[#33CCFF] hover:bg-primary"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="20"
                ...
                <a
                  href=""
                  className="relative w-8 h-8 rounded-full transition-all duration-500 flex justify-center items-center bg-[#FF0000] hover:bg-primary"
                >
                  <svg
