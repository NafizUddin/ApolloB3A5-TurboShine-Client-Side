...
const RegisterPage = () => {
  ...
  return (
    <div>
      <div className="min-h-screen bg-gray-100 py-6 flex flex-col justify-center sm:py-12 px-8 md:px-0">
        <div className="relative py-3 sm:max-w-xl sm:mx-auto">
          ...
          <div className="relative px-4 py-10 bg-white shadow-lg  sm:px-16 sm:py-12 md:w-[470px] rounded-lg">
